package gxj.study.demo.threadPool;

/**
 * @author xinjie_guo
 * @version 1.0.0 createTime:  2019/11/29 9:20
 * @description
 */
...
public class Demo {
                ...
                new ThreadPoolExecutor(
                        ...
                        new RejectedExecutionHandler() {
                            ...
                            public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
                                System.err.println("有任务"+r+"被拒绝执行了");
                            }
                        });
        testCommon(threadPoolExecutor);
        // 预计结果：
    ...
    public ThreadPoolExecutor testShutdownCommon() {
    ...
    public void threadPoolExecutorTest8() throws Exception {
        ...
        System.out.println("未结束（阻塞队列中）的任务有：" + shutdownNow.size());
